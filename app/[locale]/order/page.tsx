  ...
  return (
    <div className="pt-16 min-h-screen">
      ...
      <div className="py-16 sm:py-20 px-6 text-center bg-[#EAD9C0]/30 border-b border-[#DDD0BC]/40">
        ...
        <h1 className="font-playfair text-4xl sm:text-5xl font-bold text-[#2C1A0E] mb-4">
          {t("title")}
        </h1>
        <p className="text-[#9B8B7A] max-w-lg mx-auto leading-relaxed">{t("subtitle")}</p>
        <div className="flex items-center justify-center gap-4 mt-6 text-xs text-[#9B8B7A]/70">

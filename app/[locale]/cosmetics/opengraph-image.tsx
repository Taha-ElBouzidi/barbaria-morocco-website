...
export const alt = "Barbaria Morocco - Cosmetiques Naturels";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ width: 80, height: 1, background: "#E299A1", marginTop: 24, marginBottom: 24 }} />
        <div style={{ fontSize: 20, color: "#E299A1", letterSpacing: "0.1em" }}>
          Huile d&apos;Argan · Savon Noir · Sugar Scrub
        </div>
      </div>
    ),
    { ...size }

...
export const alt = "Barbaria Morocco - Alimentaire";
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ width: 80, height: 1, background: "#C4840A", marginTop: 24, marginBottom: 24 }} />
        <div style={{ fontSize: 20, color: "#C4840A", letterSpacing: "0.1em" }}>
          Bientot disponible
        </div>
      </div>
    ),
